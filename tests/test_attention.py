...
from llm_internals.attention.simple_attention import simple_compute_attention
from llm_internals.attention.attention import SelfAttention
...
def test_self_attention_preserves_embedding_shape():
    vocab_size = 50257
    embedding_dim = 4
    max_length = 4
